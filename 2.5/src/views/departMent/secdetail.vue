...
<template>
  <div class="Secdetail">
    <el-card class="card">
      <div class="box">
        ...
        <div class="right">
          <div class="top" style="font-size: 30px">
            <span class="span1">{{
              $store.state.departMent.userInfo.username
            }}</span>
            <span
              class="span2"
              v-if="$store.state.departMent.userInfo.enableState == 1"
              >在职</span
            >
            <span class="span3" v-else>离职</span>
          </div>
          <div class="con" style="font-size: 20px">
            <span class="span">最新工资基数</span>
            <span class="span"
              >入职时间：<span>{{
                $store.state.departMent.userInfo.timeOfEntry
                  ? $store.state.departMent.userInfo.timeOfEntry.slice(0, 10)
                  : ''
              }}</span></span
            >
            <span class="span"
              >联系电话：<span>{{
                $store.state.departMent.userInfo.mobile
              }}</span></span
            >
          </div>
          <div class="foot" style="font-size: 20px">
            <span
              >本月不缴纳社保
              <el-switch
                v-model="value"
      ...
      <div class="form">
        <el-form
          :model="$store.state.departMent.userSecurity"
          label-width="80px"
        >
          <el-form-item label="参保城市">
            <el-select
              v-model="
                $store.state.departMent.userSecurity.participatingInTheCity
              "
              placeholder="请选择"
            >
          ...
          <el-form-item label="社保基数">
            <div class="input">
              <el-input
                v-model="$store.state.departMent.userSecurity.providentFundBase"
              ></el-input>
          ...
          <el-form-item label="工伤比例">
            <div class="input">
              <el-input
                v-model="
                  $store.state.departMent.userSecurity.industrialInjuryRatio
                "
              ></el-input>
          ...
          <el-form-item label="社保缴纳">
            <div class="input">
              <div>
                ...
                <el-input
                  v-model="
                    $store.state.departMent.userSecurity.socialSecurityType
                  "
                  disabled
                  style="width: 160px"
                ></el-input>
      ...
      <div class="table">
        <el-table
          :data="$store.state.departMent.detailTableData"
          style="width: 90%"
        >
      ...
      <div class="foot">
        <div class="form">
          <el-form
            :model="$store.state.departMentuserSecurity"
            label-width="100px"
            size="mini"
          >
            <el-form-item label="社保备注">
              <el-input
                v-model="
                  $store.state.departMent.userSecurity.socialSecurityNotes
                "
                type="textarea"
                style="width: 400px"
              ></el-input>
            ...
            <el-form-item label="公积金城市">
              <el-select
                v-model="$store.state.departMent.userSecurity.providentFundCity"
                placeholder="请选择"
              >
                <el-option label="北京" value="beijing"></el-option>
              </el-select>
            ...
            <el-form-item label="公积金基数">
              <div class="input">
                <el-input
                  v-model="
                    $store.state.departMent.userSecurity.providentFundBase
                  "
                ></el-input>
            ...
            <el-form-item label="企业比例">
              <div class="input">
                <el-input
                  v-model="
                    $store.state.departMent.userSecurity.enterpriseProportion
                  "
                ></el-input>
            ...
            <el-form-item label="个人比例">
              <div class="input">
                <el-input
                  v-model="
                    $store.state.departMent.userSecurity.personalProportion
                  "
                ></el-input>
                <span>（比例范围是5％ ~ 12％，推荐12％）</span>
              </div>
              ...
              <div class="input">
                <div>
                  ...
                  <el-input
                    style="width: 160px"
                    v-model="
                      $store.state.departMent.userSecurity
            ...
            <el-form-item label="公积金备注">
              <el-input
                ...
                style="width: 400px"
                v-model="
                  $store.state.departMent.userSecurity.providentFundNotes
                "
              ></el-input>
            </el-form-item>
          </el-form>
...
export default {
  ...
  methods: {
    /*获取表格数据*/
    dateilTable() {
      this.$store.dispatch('departMent/getDetailTable')
    },
    /*获取个人信息*/
    detailinfo() {
      console.log(this.$route.params.id)
      this.$store.dispatch('departMent/getDetailinfo', this.$route.params.id)
    }
  },
  created() {
    this.dateilTable()
