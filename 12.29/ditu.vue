<template>
    <div class="userMap">
      <div id="chartsMapp"></div>
    </div>
  </template>
  
  <script charset="ISO-8859-1">
  import * as echarts from "echarts"
  import data from "@/assets/get/s/data-1528971808162-BkOXf61WX.json"
  export default {
    data() {
      return {}
    },
    methods: {
      getMychart() {
        var myChart = echarts.init(document.getElementById("chartsMapp"));
        // var uploadedDataURL = "/api"
              ...
              for (var n = 0; n < year.length; n++) {
                optionXyMap01.options.push({
                  ...
                  title: [
                    ...
                    {
                      // id: 'statistic',
                      text: "MOOC takeaway sales market",
                      left: "2%",
                      top: "6%",
                      textStyle: {
                        color: "#fff",
